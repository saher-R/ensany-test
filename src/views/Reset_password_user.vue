  ...
  <div class="Singup_user">
    <div class="content">
      <div class="top">
        ...
        <span style="font-weight: 600; font-size: 0.95rem;">Password Reset</span>
      </div>
      <form action="#" class="info">
        ...
        <button type="submit" class="SignUp-btn"
          style="margin: 16px 8px; box-shadow: 0 0 0px 3.5px rgb(127, 127, 232); font-size: 1rem!important; padding: 8px 20px!important;">
          Send a password reset link
        </button>

        <p>
          Do you remember password? <a href="#">Sing In</a>
        </p>
